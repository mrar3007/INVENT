...
class _MyStateHomePage extends State<MyHomePage> {
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                _flatButton("Начать инвентаризацию", const StartPageInvent()),
                const SizedBox(
                  height: 20.0,
                ),
                FlatButton(
                ...
                _flatButton("Добавить объект", const GeneratePage()),
                const SizedBox(
                  height: 20.0,
                ),
                FlatButton(
                ...
                _flatButton("Архив", InventListPage()),
                const SizedBox(
                  height: 20.0,
                ),
                FlatButton(
  ...
  Widget _flatButton(String text, Widget widget) {
    return FlatButton(
      color: Colors.green,
      padding: const EdgeInsets.all(20.0),
      onPressed: () async {
